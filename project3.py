   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Please write the year which number of days you want to calculate000\n",
      "Please give the number of the month0\n",
      "Total Days in Month is : False\n",
      "Please write the year which you want to check0\n",
      "Please give the number of the month for finalise checking0\n",
      "Please give the date for Checking0\n",
      "Given date is : False\n",
      "Please write the year from where you want to calculate00\n",
      "Please write the month from where you want to calculate0\n",
      "Please write the date from where you want to calculate0\n",
      "Please write the end year where to you want to calculate00\n",
      "Please write the end month where to you want to calculate0\n",
      "Please write the end date where to you want to calculate0\n",
      "Distance Between The Given Dates : 0\n",
      "Please write the year of birth0\n",
      "Please write the month of birth00\n",
      "Please write the date of birth0\n",
